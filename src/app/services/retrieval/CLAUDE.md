...
Reranking happens after this layer. See `../reranking/CLAUDE.md`. Keep the two separate:
...
- Store the model name and dimension with the vector. See `../../repositories/CLAUDE.md`.
