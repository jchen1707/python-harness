...
5. **Check the repo too.** `AGENTS.md`, `docs/architecture.md` and `docs/agents/` may
...
becomes an edit to `AGENTS.md` or `docs/architecture.md`. Propose and confirm; do not apply
